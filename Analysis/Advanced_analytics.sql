...
--- Data Segementation ---
====================================================================================
--- Segment products into costs ranges and count how many products fall into 
--- each segment
...
---   New: Customers with a lifespan less than 12 months. And find the total number of customers buy each group
